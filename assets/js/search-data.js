...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "My open source projects in Deep Learning and Computer Vision.",
          section: "Navigation",
          handler: () => {
          ...
          title: "teaching",
          description: "Deep Learning and Computer Vision courses",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%68%69%70%70%6F%6C%79%74%65%6D%61%79%61%72%64@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/hippolytemayard", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/hippolyte-mayard-5b330a140", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
